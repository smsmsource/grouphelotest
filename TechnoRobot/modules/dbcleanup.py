...
import TechnoRobot.modules.sql.global_bans_sql as gban_sql
import TechnoRobot.modules.sql.users_sql as user_sql
from TechnoRobot import DEV_USERS, OWNER_ID, dispatcher
